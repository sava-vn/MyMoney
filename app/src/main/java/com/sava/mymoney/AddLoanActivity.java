...
public class AddLoanActivity extends AppCompatActivity {
    ...
    private TextView tvtitle,tvDate,tvDate2;
    ...
    private void initView(){
        ...
        tvtitle = findViewById(R.id.addborrow_tv_title);
            ...
            public void onClick(View v) {
                if(mSBL.getmSDate().getmDay()==0 || mSBL.getmSDate2().getmDay()==0 || mSBL.getmSDate2().comperTiem(mSBL.getmSDate())<0)
                    ...
                    if(edtPerson.getText().toString().length()==0)
                        Toast.makeText(AddLoanActivity.this, "Xin hãy kiểm tra lại người vay", Toast.LENGTH_SHORT).show();
                    else{
                        try{
                            ...
                            Toast.makeText(AddLoanActivity.this, "Xin hãy kiểm tra lại số tiền", Toast.LENGTH_SHORT).show();
                        }
                    }
                }
            }
